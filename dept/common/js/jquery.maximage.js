// Copyright c2009 Aaron Vanderzwan, by Aaron Vanderzwan
...
jQuery.fn.maxImage = function(options) {
  ...
  function _start_timer() {
    ...
    // Fade in first image
    $('.slide-'+currentSlide).css({'z-index':opts.zIndex}).fadeIn(800, 'linear');
    setMainText();
    ...
    var slideInterval = setInterval(function(){
      ...
      $('.slide-'+lastSlide).css({'z-index':opts.zIndex-1}).fadeOut(800);
      $('.slide-'+currentSlide).css({'z-index':opts.zIndex}).fadeIn(800, 'linear');
     setMainText();
     if(opts.slideShowTitle){
