<?php /* Smarty version 2.6.26, created on 2012-02-29 02:03:36
         compiled from _index_tpl.html */ ?>
...
<div id="contentsContainer">
	<div id="contentsArea">
		...
		<div id="inquiryArea">
<?php if ($this->_tpl_vars['mode'] == "" && $this->_tpl_vars['error'] == ""): ?>
			<h2><img src="images/tel_title.png" width="421" height="45" alt="お電話でのご予約・お問い合わせ" /></h2>
			<p id="inquiryTel"><img src="images/tel2.png" width="550" height="50" alt="" /></p>
<?php endif; ?>
...
<?php elseif ($this->_tpl_vars['mode'] == "" && $this->_tpl_vars['error'] == ""): ?>
...
<?php elseif ($this->_tpl_vars['mode'] == 'confirm'): ?>
			...
			<div id="inquiryForm"><div class="inner">
				<form action="./" method="post">
					<dl>
						...
						<dd><?php echo $this->_tpl_vars['name']; ?>
</dd>
					</dl>
					<dl>
						<dt><img src="images/form_text03.gif" width="68" height="28" alt="フリガナ※" /></dt>
						<dd><?php echo $this->_tpl_vars['kana']; ?>
</dd>
					</dl>
					<dl>
						<dt><img src="images/form_text04.gif" width="79" height="28" alt="電話番号※" /></dt>
						<dd><?php echo $this->_tpl_vars['tel01']; ?>
 - <?php echo $this->_tpl_vars['tel02']; ?>
 - <?php echo $this->_tpl_vars['tel03']; ?>
<?php if ($this->_tpl_vars['mode'] != 'confirm'): ?><p>例）011-512-7472　<em>半角数字</em></p><?php endif; ?></dd>
					</dl>
					<dl>
						<dt><img src="images/form_text05.gif" width="134" height="28" alt="連絡可能な時間帯※" /></dt>
						<dd><?php echo $this->_tpl_vars['time']; ?>
</dd>
					</dl>
					<dl>
						<dt><img src="images/form_text06.gif" width="54" height="28" alt="内容※" /></dt>
						<dd><?php echo $this->_tpl_vars['comm']; ?>
</dd>
					</dl>

<?php if ($this->_tpl_vars['mode'] == 'confirm'): ?>
					<p class="btn"><input type="image" src="images/btn_back_op.gif" name="back_btn" alt="戻る" /> <input type="image" src="images/btn_send_op.gif" value="上記内容で送信する" alt="上記内容で送信する" /><input type="hidden" name="mode" value="fin" /></p>
<?php else: ?>
