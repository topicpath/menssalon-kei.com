...
<p class="date">2013年06月19日</p>
<div class="title"><h2>加齢臭、気になりませんか？</h2></div>

<div class="body">加齢臭って言葉を最近はよく聞くようになりました。<br />皆さんは加齢臭対策、していますか？加齢臭は耳の後ろやＴゾーン、胸や背中から発生するノネナールという物質<br />が原因と言われています。マメにシャワーを浴びるだけでもそれなりに効果が高いそうです。<br />これから夏場の汗のかき易い時期、日に何度もシャワーを浴びるのも難しいですし！<br />そこで加齢臭予防のボディーローションがクラシエから発売されています。『オトコ香る』150ｍｌ ￥1200 で当店にて取り扱いしております。ベルガモットの香りが良いですよ(^｡^)<a href="http://www.menssalon-kei.com/message/assets_c/2013/06/111-148.php" onclick="window.open('http://www.menssalon-kei.com/message/assets_c/2013/06/111-148.php','popup','width=700,height=525,scrollbars=no,resizable=no,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0'); return false"><img src="http://www.menssalon-kei.com/message/assets_c/2013/06/111-thumb-250x187-148.jpg" width="250" height="187" alt="111.jpg" class="mt-image-left" style="float: left; margin: 0 20px 20px 0;" /></a> </div>


<p class="text_c"><a href="/message/2013/07/post-26.php">&lt;&lt; 前へ</a>　<a href="/message/">一覧を見る</a>｜<a href="/message/2013/06/4.php">次へ &gt;&gt;</a></p>
